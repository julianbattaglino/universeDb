package com.example.julian.universedb.actividadesuniverso;
 ...
 */
public class PlanetasActivity extends BaseView<MyDbActivity, DbViewModel>
    ...
    public PlanetasActivity(MyDbActivity activity, DbViewModel viewModel) {
