 ...
 */
public class FragmentoConstelaciones extends Fragment implements View.OnClickListener {
    ...
    public FragmentoConstelaciones() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragmentoconstelaciones, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tvconstelaciones = view.findViewById(R.id.tvconstelaciones);
        ImageView constelaciones = view.findViewById(R.id.constelaciones);


        AnimationUtils.enterLeft(tvconstelaciones, 2500);

        AnimationUtils.enterRight(constelaciones, 1000);
